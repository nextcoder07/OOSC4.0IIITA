        ...
        <div className="contact-info-panel">
          ...
          <div className="contact-details-cards">
            <div className="contact-detail-card glass-card">
              <span className="icon"><Mail size={24} color="#d93025" /></span>
              <div>
            ...
            <div className="contact-detail-card glass-card">
              <span className="icon"><Phone size={24} color="#4ade80" /></span>
              <div>
                <h4>Call / WhatsApp</h4>
                <p>+91 7318 295 789</p>
              </div>
            ...
            <div className="contact-detail-card glass-card">
              <span className="icon"><MapPin size={24} color="#60a5fa" /></span>
              <div>
