  ...
  return (
    <div className="app-shell">
      ...
      <main className="page-body"><Routes>
          <Route path="/" element={<Home heroData={heroData} aboutData={aboutData} navigate={navigateTo} />} />
          ...
          <Route path="/hackathon" element={<Hackathon siteConfig={siteConfig} />} />
          <Route path="/register" element={<Registration onSubmit={() => setAdminMessage('Registration interest captured successfully!')} />} />
          <Route path="/contact" element={<Contact siteConfig={siteConfig} form={form} setForm={setForm} formStatus={formStatus} submitContact={submitContact} />} />
