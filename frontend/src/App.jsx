...
function App() {
  ...
  const navigateTo = (pageKey) => {
    if (pageKey === 'admin' || pageRoutes.some((route) => route.key === pageKey) || pageKey === 'home') {
      if (pageKey === 'home') {
        navigate('/')
      } else {
        navigate('/' + pageKey)
  ...
  return (
    <div className="app-shell">
      ...
      {/* Page Content Body */}
      <main className="page-body"><Routes>
          <Route path="/" element={<Home heroData={heroData} aboutData={aboutData} siteConfig={siteConfig} navigate={navigateTo} />} />
          <Route path="/schedule" element={<Schedule filteredSchedule={filteredSchedule} activeDay={activeDay} setActiveDay={setActiveDay} adminMode={adminMode} draggedResource={draggedResource} draggedIndex={draggedIndex} dragOverIndex={dragOverIndex} handleDragStart={handleDragStart} handleDragOver={handleDragOver} handleDragEnd={handleDragEnd} handleDrop={handleDrop} openModal={openModal} editRecord={editRecord} deleteRecord={deleteRecord} setSchedule={setSchedule} siteConfig={siteConfig} getEventTime={getEventTime} getEventDesc={getEventDesc} />} />
          <Route path="/speakers" element={<Speakers speakers={speakers} adminMode={adminMode} draggedResource={draggedResource} draggedIndex={draggedIndex} dragOverIndex={dragOverIndex} handleDragStart={handleDragStart} handleDragOver={handleDragOver} handleDragEnd={handleDragEnd} handleDrop={handleDrop} openModal={openModal} editRecord={editRecord} deleteRecord={deleteRecord} setSpeakers={setSpeakers} siteConfig={siteConfig} />} />
          <Route path="/sponsors" element={<Sponsors sponsors={sponsors} adminMode={adminMode} draggedResource={draggedResource} draggedIndex={draggedIndex} draggedCategory={draggedCategory} dragOverIndex={dragOverIndex} handleDragStart={handleDragStart} handleDragOver={handleDragOver} handleDragEnd={handleDragEnd} handleDrop={handleDrop} openModal={openModal} editRecord={editRecord} deleteRecord={deleteRecord} setSponsors={setSponsors} siteConfig={siteConfig} sponsorCategories={sponsorCategories} sortedSponsors={sortedSponsors} />} />
          <Route path="/team" element={<Team team={team} adminMode={adminMode} draggedResource={draggedResource} draggedIndex={draggedIndex} draggedCategory={draggedCategory} dragOverIndex={dragOverIndex} handleDragStart={handleDragStart} handleDragOver={handleDragOver} handleDragEnd={handleDragEnd} handleDrop={handleDrop} openModal={openModal} editRecord={editRecord} deleteRecord={deleteRecord} setTeam={setTeam} siteConfig={siteConfig} categorizedTeam={categorizedTeam} />} />
          <Route path="/hackathon" element={<Hackathon siteConfig={siteConfig} navigate={navigateTo} />} />
          <Route path="/register" element={<Registration onSubmit={() => setAdminMessage('Registration interest captured successfully!')} />} />
          <Route path="/contact" element={<Contact siteConfig={siteConfig} form={form} setForm={setForm} formStatus={formStatus} submitContact={handleFormSubmit} />} />
          <Route path="/admin" element={<AdminLogin loginEmail={loginEmail} setLoginEmail={setLoginEmail} loginPassword={loginPassword} setLoginPassword={setLoginPassword} handleLogin={handleLogin} adminMessage={adminMessage} siteConfig={siteConfig} />} />
        </Routes></main>
